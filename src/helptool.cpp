...
ECS::Entity Helptool::createHelptool(vec2 position,std::string name)
{
    auto entity = ECS::Entity();

    std::string key = "help_tool";
    ...
    helpcomponent.scale = vec2({ 0.3f, 0.2f }) * static_cast<vec2>(resource.texture.size);
